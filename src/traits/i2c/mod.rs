...
pub trait I2cDmaAnyTrait<SCL, SDA>: Peripheral + Instance {
    fn build_with_dma_config_any<TxDma, RxDma>(self, scl: SCL, sda: SDA, tx_dma: impl Peripheral<P=TxDma> + 'static, rx_dma: impl Peripheral<P=RxDma> + 'static, freq: Hertz, config: Config) -> I2c<'static, Async>;

    fn build_with_dma_any<TxDma, RxDma>(self, scl: SCL, sda: SDA, tx_dma: impl Peripheral<P=TxDma> + 'static, rx_dma: impl Peripheral<P=RxDma> + 'static, freq: Hertz) -> I2c<'static, Async> {
...
pub trait I2cDmaTrait<SCL, SDA, TxDma = NoDma, RxDma = NoDma>: I2cDmaAnyTrait<SCL, SDA> {
    fn build_with_dma_config(self, scl: SCL, sda: SDA, tx_dma: impl Peripheral<P=TxDma> + 'static, rx_dma: impl Peripheral<P=RxDma> + 'static, freq: Hertz, config: Config) -> I2c<'static, Async> {
        self.build_with_dma_config_any(scl, sda, tx_dma, rx_dma, freq, config)
    }

    fn build_with_dma(self, scl: SCL, sda: SDA, tx_dma: impl Peripheral<P=TxDma> + 'static, rx_dma: impl Peripheral<P=RxDma> + 'static, freq: Hertz) -> I2c<'static, Async> {
...
pub trait I2cTrait<SCL, SDA>: I2cDmaTrait<SCL, SDA> {
    fn build_with_config(self, scl: SCL, sda: SDA, freq: Hertz, config: Config) -> I2c<'static, Async> {
        self.build_with_dma_config(scl, sda, NoDma, NoDma, freq, config)
    }

    fn build(self, scl: SCL, sda: SDA, freq: Hertz) -> I2c<'static, Async> {
