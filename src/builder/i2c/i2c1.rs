...
impl I2c1Builder {
    ...
    pub fn build_blocking_sda(
        ...
        match sda {
            I2c1Sda::PB7(pb7) => {
                I2c::new_blocking(base.i2c, scl, pb7, base.freq.unwrap_or_else(|| { Hertz(1) }), base.config.unwrap_or_default())
            }
            #[cfg(PB9)]
            I2c1Sda::PB9(pb9) => {
                I2c::new_blocking(base.i2c, scl, pb9, base.freq.unwrap_or_else(|| { Hertz(1) }), base.config.unwrap_or_default())
            }
        }
    }
}
